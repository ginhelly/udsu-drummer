...
function generateSl() {
    let mylist = ["Учим ударения в словах просто и безболезненно.",
        ...
        "Орфоэпик фэйл",
        "Кто анимешник? Я анимешник? Да с чего вы взяли?\n\nДа, кстати, для тех, кто говорит \"áниме\", уже заготовлен отдельный котёл"]
...
function step() {
    ...
    // Хуйнём последний элемент из списка
    ourword = ml.pop();
    rl.push(ourword);
...
function paint() {
    ...
    if (second != 0) {
        ...
        note.innerHTML = "Допускаются два варианта, <b>жирный</b> предпочтительнее";
    }
}
